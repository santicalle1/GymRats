...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-11-2023 a las 03:40:56
...
(47, 'Straps Negros', 12750.00, 3, 'uploads/1700665496_4702b6f42b00c66ac9ec.webp', 'son comodos', 'oferta', 15.00),
...
INSERT INTO `profesores` (`id_profesor`, `nombre`, `especialidad`, `fecha_de_contrato`, `titulos`, `horarios`, `coste`, `dificultad`, `imagen`) VALUES
(1, 'h', 'h', '2023-11-23 03:00:00', 'h', '00:00:00', 0, '', 'uploads/1701300878_eb241b5248ad99213fff.webp'),
(2, 'Tadeo', 'Yoga', '2023-11-16 03:00:00', 'ggg', '00:00:00', 100002, 'ezzzzzzzz', 'uploads/1701301071_47bc2e0abe41cc0b32f3.jpg'),
(4, 'Kaka', 'comer', '2023-11-29 03:00:00', 'vvvvvvv', '00:00:00', 565, 'hard', '');
...
--
ALTER TABLE `barrio`
  MODIFY `id_barrio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT de la tabla `calle`
--
ALTER TABLE `calle`
  MODIFY `id_calle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT de la tabla `carrito`
--
ALTER TABLE `carrito`
  MODIFY `id_carrito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=165;

--
-- AUTO_INCREMENT de la tabla `ciudad`
--
ALTER TABLE `ciudad`
  MODIFY `id_ciudad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `direccion`
  MODIFY `id_envio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `provincia`
  MODIFY `id_provincia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
