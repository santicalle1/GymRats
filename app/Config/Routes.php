...
$routes->post('/confirmarCarrito','CarritoController::confirmarCarrito');// Eliminar producto del carrito
...
$routes->get('panel_cliente/(:num)', 'ProfesoresController::procesarCompra/$1');
