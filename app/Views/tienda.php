...
<?php if (isset($producto['id_producto'])): ?>
    <form action="<?= base_url('/agregarAlCarrito') ?>" method="post" class="form-agregar" onsubmit="return verificarAgregarAlCarrito(<?= esc($producto['id_producto']) ?>, <?= esc($producto['stock']) ?>)">
